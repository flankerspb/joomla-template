...
$type = $this->escape($this->item->category_title);
...
$header = array();
$header['top1'] = $this->escape($this->params->get('page_heading'));
$header['top2'] = $category;
$header['main'] = $title;
		...
		<div class="uk-grid uk-grid-width-1-1">
			...
			<div class="fl-block-props uk-width-small-2-3 uk-width-medium-1-2">
				...
				<table class="uk-table">
					...
					<?php endif; ?>
					<tr>
						<td class="uk-text-bold">Тип:</td><td><?php echo $type; ?></td>
					</tr>
						<?php 
