...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure', 0)); ?>" method="post" id="login-form" class="uk-form">
	...
	<div class="userdata">
		...
		<div id="form-login-submit" class="control-group">
			<div class="controls">
				<button type="submit" tabindex="0" name="Submit" class="uk-button"><?php echo JText::_('JLOGIN'); ?></button>
			</div>
		</div>
		<?php
