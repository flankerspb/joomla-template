...
$data = $tparams->get(strtolower(str_replace('-', '_',$lang)));

$name = $data->name ? $data->name : $this->contact->name;
...
<article class="fl-article-contact asd" itemscope itemtype="https://schema.org/Organization">
		...
		<div class="uk-grid">
			<div class="uk-width-1-1 uk-width-large-1-2">
				<div class="uk-panel uk-block uk-text-center">
					...
					<?php if ($data->legal_name) : ?>
					<meta itemprop="legalName" content="<?php echo $data->legal_name; ?>" />
					<?php endif; ?>
					
					
					<?php if ($data->founding_date) : ?>
					<meta itemprop="foundingDate" content="<?php echo $data->founding_date; ?>" />
					<?php endif; ?>
					...
					<?php if (($data->address || $data->suburb  || $data->state || $data->country || $data->postcode) : ?>
						...
						<div class="contact-address uk-margin-top uk-text-large"  itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
							...
							if ($data->country)
							{
								...
								{
									echo '<meta itemprop="addressCountry" content="' . $data->country . '" />';
								}
							}
							if ($data->postcode)
							{
								...
								{
									echo '<meta itemprop="postalCode" content="' . $data->postcode . '" />';
								}
							}
							if ($data->state)
							{
								...
								{
									echo '<meta itemprop="addressRegion" content="' . $data->state . '" />';
								}
							}
							if ($data->suburb)
							{
								...
								{
									echo '<meta itemprop="addressLocality" content="' . $data->suburb . '" />';
								}
							}
							if ($data->address)
							{
								...
								{
									echo '<meta itemprop="streetAddress" content="' . $data->address . '" />';
								}
							}
							?></span>
						</div>
