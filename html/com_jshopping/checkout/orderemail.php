    ...
    <td colspan="2" style="padding:0px;padding-top:10px;">
       <table width="100%" cellspacing="0" cellpadding="0" class="table_items">
        <tr><td colspan="5" style="vertical-align:top;padding-bottom:5px;font-size:1px;"><div style="height:1px;border-top:1px solid #999;"></div></td></tr>
         ...
         <tr class="vertical">
           ...
           <td><span class="qtyval"><?php print formatqty($prod->product_quantity);?></span><?php print $prod->_qty_unit;?></td>
           <td>
      ...
      <?php if ($this->show_total_info){?>
         ...
         <tr>
           ...
           <td class="price subtotal"><?php print formatprice($this->order->order_subtotal, $order->currency_code); ?><?php print $this->_tmp_ext_subtotal?></td>
         </tr>
         <?php } ?>
         ...
         <tr>
           ...
           <td class="price discount">-<?php print formatprice($this->order->order_discount, $order->currency_code); ?><?php print $this->_tmp_ext_discount?></td>
         </tr>
         <?php } ?>
				 
         <?php if (!$this->config->without_shipping && $this->order->order_shipping > 0){?>
         <tr>
           <td colspan="4" align="right" style="padding-right:15px;"><?php print _JSHOP_SHIPPING_PRICE ?>:</td>
           <td class="price shipping"><?php print formatprice($this->order->order_shipping, $order->currency_code); ?><?php print $this->_tmp_ext_shipping?></td>
         </tr>
         <?php } ?>
         ...
         <tr>
           ...
           <td class="price PACKAGE"><?php print formatprice($this->order->order_package, $order->currency_code); ?><?php print $this->_tmp_ext_shipping_package?></td>
         </tr>
         <?php } ?>
         ...
         <tr>
           ...
           <td class="price payment"><?php print formatprice($this->order->order_payment, $order->currency_code); ?><?php print $this->_tmp_ext_payment?></td>
         </tr>
         <?php } ?>
         ...
         <tr>
           <td colspan="4" align="right" style="padding-right:15px;"><?php print displayTotalCartTaxName($order->display_price);?><?php if ($this->show_percent_tax) print " ".formattax($percent)."%";?>:</td>
             <td class="price tax"><?php print formatprice($value, $order->currency_code); ?><?php print $this->_tmp_ext_tax[$percent]?></td>
         </tr>
         <?php } ?>
         <?php } ?>
         ...
         <tr>
           ...
           <td class="price order_total"><b><?php print formatprice($this->order->order_total, $order->currency_code)?><?php print $this->_tmp_ext_total?></b></td>
         </tr>
