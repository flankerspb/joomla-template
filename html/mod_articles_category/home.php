...
<div class="uk-block <?php echo $moduleclass_sfx; ?>">
	<div class="uk-container uk-container-center" itemscope itemtype="http://schema.org/ItemList">
		...
		<ul class="uk-grid uk-grid-large uk-grid-width-1-2 uk-grid-width-small-1-3 uk-grid-width-medium-1-3 uk-flex uk-flex-center" data-uk-grid-match="{row: false, target:'h3'}" data-uk-grid-margin>
